...
params:
  ...
  signal_file: "kinome_data/ad_ipsc/SigmBg.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/ad_ipsc/SigSat.txt" # Change the file name to the one you have
...
comparisons <- list(
  COMP1 = c(groups[[4L]], groups[[1L]]),
  COMP2 = c(groups[[8L]], groups[[5L]]),
  COMP3 = c(groups[[12L]], groups[[9L]])
)
```
